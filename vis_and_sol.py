...
@st.cache_data
def load_data():
    enrol = pd.read_csv("https://drive.google.com/file/d/17wKsdxmL_GXR7oV0QwUXnh24LxjpljJe/view?usp=drive_link")
    demo = pd.read_csv("https://drive.google.com/file/d/1vAey25vrPS9L-g7JGSSlmenM10de-jEV/view?usp=drive_link")
    bio = pd.read_csv("https://drive.google.com/file/d/1vfTLfes1DeltmPHbmnA6OfJNkYkqqBcy/view?usp=drive_link")
